export default {
  dyform: {
    header: {
      ...
      content_parse_error:
        'Content parsing exception, please check the text content',
      undo: 'undo',
      redo: 'redo'
    },
    close: 'Close',
    ...
    properties: {
      ...
      tip: 'Tip',
      result_tip:
        'Please click on the preview to view the actual preview effect',
      ...
      dynamic_visible_tip:
        'Please enter the visible script to identify the binding data for the current entire form',
      dynamic_disabled: 'Disabled',
      dynamic_disabled_tip:
        'Please enter the disabled script to identify the binding data for the current entire form',
    ...
    rules: {
      ...
      script: 'Script',
      script_tip:
        'In the expression, $represents global form data, and $row represents data in a single row within a dynamic table',
    ...
    item: {
      ...
      upload: {
        ...
        file_url_path_placeholder:
          'Required,Parse the EPL address of the file URL after successful upload',
        file_id_path_placeholder:
          'Parse the epl address of the file ID after successful upload',
      ...
      table: {
        ...
        no_del_by_merge:
          'The current cell has been merged and cannot be deleted',
      ...
      dataTable: {
        ...
        no_column_tip:
          'Please click on the plus sign in the bottom left corner to add the fields'
      },
      code: {
        name: 'Code',
        script: 'Rule',
        script_placeholder:
          'Please input the rule function to return the specific code',
        api_path: 'API',
        api_path_placeholder: 'Please input the API path',
        data_url_path: 'Data Url',
        data_url_path_placeholder:
          'Required, the EPL address for parsing data after successful '
      }
    }
  }
};
