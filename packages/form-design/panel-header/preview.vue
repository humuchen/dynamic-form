<template>
  ...
  >
    ...
    <span slot="footer" class="dialog-footer">
      ...
      <el-button type="primary" size="mini" @click="handleValidator">{{
        t('dyform.validator')
      }}</el-button>
      <el-button type="primary" size="mini" @click="handleGetData">{{
        t('dyform.header.get_data')
      }}</el-button>
      <el-button type="primary" size="mini" @click="handleView">
        {{
          preview ? t('dyform.header.write_mode') : t('dyform.header.read_mode')
        }}
      </el-button>
    </span>

    <el-dialog
      :title="t('dyform.header.get_data')"
