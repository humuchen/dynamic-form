<template>
  <el-col :span="record.span || 24">
    <div
      :class="{
        active: selectItem && record.key === selectItem.key,
        'drag-box': isDrag,
        'node-item': isDrag
      }"
    ...
    >
      ...
      <template v-if="isDrag">
        ...
        <div class="node-control">
          <div
            class="copy pointer"
            :title="t('dyform.item.copy')"
            :class="
              selectItem && record.key === selectItem.key
                ? 'active'
                : 'unactivated'
            "
...
.form-item-box .el-form-item__content {
  display: flex;
  align-items: center;
}
...
.drag-box .node-control .copy.unactivated,
.drag-box .node-control .delete.unactivated {
  opacity: 0 !important;
  pointer-events: none;
}

.drag-box .node-control .copy.active,
.drag-box .node-control .delete.active {
  opacity: 1 !important;
}
