...
<template>
  <component
    ...
    :style="{
      margin:
        record.margin && record.margin.length > 0
          ? record.margin.join('px ') + 'px'
          : '0px',
      borderRadius:
        (record.itemBorderRadius ? record.itemBorderRadius : 0) + 'px',
