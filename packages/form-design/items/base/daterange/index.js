  ...
  columns: [
    {
      ...
      prop: 'label',
      default: $t('dyform.item.daterange.name'), //日期区间',
      span: 24,
      rules: labelRules()
    },
    {
  ...
  group: [
    {
      ...
      column: [
        ...
        },
        {
          ...
          prop: 'defaultValue',
          type: 'daterange',
          startPlaceholder: $t('dyform.item.date.satrt_placeholder'),
          endPlaceholder: $t('dyform.item.date.end_placeholder'),
          span: 24
        },
        {
          label: $t('dyform.item.placeholder'), //'输入提示1',
        ...
        {
          label: $t('dyform.item.placeholder'),
