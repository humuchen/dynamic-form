  ...
  columns: [
    {
      ...
      prop: 'label',
      default: $t('dyform.item.grid.name'), //'栅格布局',
      span: 24,
      show: false
    },
    {
    ...
    // 默认栅格值回填
    {
      label: $t('dyform.item.grid.columns'), //'栅格默认值',
      prop: 'columns',
      show: false,
      default: [
        {
  ...
  group: [
    {
      ...
      column: [
        {
          label: $t('dyform.item.grid.gutter'), //'栅格间隔',
          prop: 'gutter',
          type: 'number',
          min: 0,
          default: 10,
        ...
        {
          label: $t('dyform.item.style'), //'样式style',
          prop: 'customStyle',
          type: 'textarea',
          span: 24,
          show: false
        ...
        {
          label: $t('dyform.item.class'), //'样式class',
          prop: 'customClass',
          type: 'textarea',
          span: 24,
          show: false
